...
This project has uses different browsers for parallel testing, and different resolution for different mobile devices. It is based on Page object model design pattern and Data driven testing for different data sets.
